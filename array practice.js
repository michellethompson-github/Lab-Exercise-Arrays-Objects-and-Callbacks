...
function evenFinder(nums){
  ...
  //make a for loop that loops the nums array

  //while looping if the number is even addes to the answers array
  if (somehting) {
    answers.push()
  }
  
  //write an if ststement to determine if the number is even
  //How do I add a number to an array?
  //array.push() method
  

  //while looping if the number is odd do nothing
  //return array called answers (will only have even numbers)
  //return an array
